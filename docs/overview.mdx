...
<Steps>
    ...
    <Info>A **scope** is a dot-separate string that describes the type of text. For example, in PHP, a variable might have the scope `variable.other.php`.</Info>
    </Step>

    <Step title="Highlighting">
    Once Phiki has tokenize your code, it then uses a Visual Studo Code theme to highlight the tokens.
